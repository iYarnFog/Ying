...
public class YingNMS {
    ...
    static
    {
        ...
        try {
            ...
            class_EntityProjectile = YingNMS.getBukkitClass("net.minecraft.server.EntityProjectile");
            class_EntityFireball = YingNMS.getBukkitClass("net.minecraft.server.EntityFireball");
            class_EntityArrow = YingNMS.getBukkitClass("net.minecraft.server.EntityArrow");
            class_CraftArrow = YingNMS.getBukkitClass("org.bukkit.craftbukkit.entity.CraftArrow");
    ...
    public static Class<?> getClass(String className) {
        Class<?> result = null;
        try {
            result = YingNMS.class.getClassLoader().loadClass(className);
        } catch (Exception ex) {
            result = null;
        }
    ...
    public static Class<?> fixBukkitClass(String className) throws ClassNotFoundException {
        ...
        return YingNMS.class.getClassLoader().loadClass(className);
    }
    ...
    public static boolean hasMeta(ItemStack stack, String tag) {
        if (YingNMS.isEmpty(stack)) return false;
    ...
    public static Object getNode(ItemStack stack, String tag) {
        if (YingNMS.isEmpty(stack)) return null;
        Object meta = null;
        try {
    ...
    public static void removeMeta(ItemStack stack, String tag) {
        if (YingNMS.isEmpty(stack)) return;
    ...
    public static boolean getMetaBoolean(ItemStack stack, String tag, boolean defaultValue) {
        if (YingNMS.isEmpty(stack)) return defaultValue;
