 ...
 */
public class YingCrashHandler implements Thread.UncaughtExceptionHandler {

    private static YingCrashHandler sInstance = null;
    private Thread.UncaughtExceptionHandler mDefaultHandler;
    private Context mContext;
    // 保存手机信息和异常信息
    private Map<String, String> mMessage = new HashMap<>();

    public static YingCrashHandler getInstance() {
        if (sInstance == null) {
            synchronized (YingCrashHandler.class) {
                if (sInstance == null) {
                    synchronized (YingCrashHandler.class) {
                        sInstance = new YingCrashHandler();
                    }
                }
            }
        }
